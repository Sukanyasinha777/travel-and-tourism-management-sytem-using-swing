...
Thread t1;
    ...
    public void run(){
        ...
        String[] text=new String[]{"Raddison Hotel","Sayaji Hotel","Marriot Hotel","Classical Hotel","Breeze Hotel","Taj Hotel","Paradice Hotel","Royal Blue Hotel","Queen's Palace","Royal Empire"};
        try{
            for(int i=0;i<=9;i++){
    ...
    CheckHotels(){
        ...
        caption=new JLabel();
        caption.setBounds(50,500,550,70);
